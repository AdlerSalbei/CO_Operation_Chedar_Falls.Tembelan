...
class SOGBLACK {
    class AllUnits {
        ...
        primaryWeaponOptics = "rhsusf_acc_su230_mrds";
    ...
    class Type {
        ...
        class Helipilot_F: Soldier_F {
            ...
            addItemsToUniform[] = {
                ...
                LIST_1("rhs_mag_30Rnd_556x45_M855A1_Stanag_No_Tracer"),
        ...
        class sniper_F: spotter_F {
            ...
            primaryWeaponMuzzle = "rhsusf_acc_M2010S_wd";
            primaryWeaponPointer = "";
            primaryWeaponOptics = "optic_LRPS_tna_F";
            primaryWeaponUnderbarrel = "HLC_bipod_UTGShooters";
            primaryWeaponUnderbarrelMagazine = "";
            backpack = "";
